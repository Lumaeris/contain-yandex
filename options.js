...
function onOptionsPageSave(e)
{
	...
	browser.storage.sync.set({
		...
		"ignore_tunepages": document.querySelector("#ignore_tunepages").checked,
		"ignore_maps": document.querySelector("#ignore_maps").checked,
		"ignore_zen": document.querySelector("#ignore_zen").checked,
...
function onOptionsPageLoaded()
{
	...
	storageItem.then((res) =>
	{
		...
		document.querySelector("#ignore_tunepages").checked = res.ignore_tunepages || false;
		document.querySelector("#ignore_maps").checked = res.ignore_maps || false;
		document.querySelector("#ignore_zen").checked = res.ignore_zen || false;
